...
SELECT status, fn_status_emoji(status) AS status_com_emoji FROM consultas LIMIT 10;
SELECT valor, fn_classificar_valor(valor) AS classificacao FROM consultas LIMIT 10;
