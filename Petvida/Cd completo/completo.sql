CREATE DATABASE IF NOT EXISTS petvida CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE petvida;
...
CREATE TABLE consultas (
  ...
  status ENUM('agendada','em_atendimento','concluida','cancelada','pendente') NOT NULL DEFAULT 'agendada',
